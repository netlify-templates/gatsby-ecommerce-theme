...
test('Cart page | All elements in header exist', async ({ page }) => {
  ...
  await expect(rootDiv.locator('p')).toHaveText('We are now processing your order. If you have any concerns feel free to email us at customerservice@example.com');
