...
const CardController = (props) => {
  ...
  return (
    <div>
      <div className={`${styles.webRoot} ${visible === true ? styles.show : styles.hide}`}>
        <Container>
          ...
          <div className={styles.mobileFilterContainer}>
            ...
            {category === undefined && 
              ...
              {filterState?.map((filterItem, categoryIndex) => {
                return(
                  <div key={categoryIndex} className={styles.filterItemContainer} role={'presentation'} onClick={() => setCategory({...filterItem, categoryIndex: categoryIndex})}>
            ...
            {category !== undefined && 
              <div className={styles.mobileCategoryContainer}>
                <div className={styles.mobileHeader} role={'presentation'} onClick={()=>setCategory(undefined)}>
                  <Icon symbol={'arrow'}></Icon>
