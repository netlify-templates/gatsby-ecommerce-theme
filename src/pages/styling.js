      ...
      <Layout>
        ...
        <div className={styles.root}>
            ...
            <div className={styles.grid4}>
                <div className={styles.brand} style={{backgroundColor:'var(--standard-black)'}}>
                    <span className={styles.text}>Black</span>
                    <span className={styles.text}>#000000</span>
                </div>
                <div className={styles.brand} style={{backgroundColor:'var(--standard-gold)'}}>
                    <span className={styles.text}>Gold</span>
                    <span className={styles.text}>#B59F66</span>
                </div>
                <div className={styles.brand} style={{backgroundColor:'var(--standard-dark-grey)'}}>
                    <span className={styles.text}>Tarmak</span>
                    <span className={styles.text}>#545250</span>
                </div>
                <div className={styles.brand} style={{backgroundColor:'var(--standard-light-grey)'}}>
                    <span>Milk</span>
                    <span>#FCFAF6</span>
            ...
            <div className={styles.grid}>
                ...
                <Button level={'primary'} disabled>Disabled - Primary</Button>
                <Button level={'secondary'}>Enabled - Secondary</Button>
                <Button level={'secondary'}>Hovered - Secondary</Button>
                <Button level={'secondary'} disabled>Disabled - Secondary</Button>
            </div>
          </div>
          </Container>
    </Layout>
