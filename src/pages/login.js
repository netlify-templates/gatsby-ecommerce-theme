...
const LoginPage = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if(validForm === true) {
      ...
      if(loginForm.email === 'user@example.com') {
    ...
    <Layout disablePaddingBottom={true}>
      ...
      <div className={styles.root}>
        ...
        <div className={styles.loginFormContainer}>
          ...
          <form noValidate className={styles.loginForm} onSubmit={(e) => handleSubmit(e)}>
            <FormInputField 
              id={'email'}
          ...
          <Button fullWidth type={'submit'} level={'primary'}>LOG IN</Button>
          <span className={styles.createLink}>New Customer? </span>
          <Button type={'button'} onClick={() => navigate('/signup')} fullWidth level={'secondary'}>create an account</Button>
        </form>
        </div>
